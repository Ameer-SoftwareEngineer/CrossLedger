...
namespace CrossLedger.Integration.Tests.Identity;
...
public sealed class TotpProviderTests
{
    ...
    public void The_qr_code_uri_carries_the_secret_issuer_and_account_for_authenticator_apps()
    {
        ...
        var uri = _provider.GenerateQrCodeUri(secret, "user@example.com", "CrossLedger");

        uri.Should().StartWith("otpauth://totp/CrossLedger:user%40example.com");
