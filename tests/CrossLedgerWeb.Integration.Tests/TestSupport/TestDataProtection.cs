...
namespace CrossLedgerWeb.Integration.Tests.TestSupport;

// CrossLedgerWebDbContext needs an IDataProtectionProvider to encrypt TOTP secrets at
...
{
    public static IDataProtectionProvider Provider { get; } = DataProtectionProvider.Create("CrossLedgerWeb.Tests");
}
